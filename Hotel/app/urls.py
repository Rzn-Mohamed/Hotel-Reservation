...
urlpatterns = [
  ...
  path("clientAddreservation/<int:price>/<int:room>",views.client_reservation,name="client-Addreservation"),
  path("clientAddreservationForm",views.clientAddreservationForm,name="clientAddreservationForm"),
